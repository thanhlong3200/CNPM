					...
					<div class="row">
						<div class="col-lg-6">
							<div class="product-pic-zoom">
								<img class="product-big-img" src="${product.imageURL}" alt="">
								<div class="zoom-icon">
							...
							<div class="product-thumbs">
								<div class="product-thumbs-track ps-slider owl-carousel">
									<c:forEach items="${product.images}" var="image">
										<div class="pt active" data-imgbigurl="${image.imageURL}">
							...
							<div class="product-details">
								...
								<div class="pd-size-choose">
									...
									<c:forEach items="${product.stocks}" var="stock">
										...
										<div class="sc-item">
											<input type="radio" id="sm-size"> <label
												for="sm-size" class="stockSize" id = "stock${stock.id}">${stock.size}</label>
										</div>
...
<script type="text/javascript">
	$('.stockSize').on("click", function(){
		$('#stockQuantity p').css("display","none");
		var data_stock = $(this).attr('id');

		$('#stockQuantity p').each(function() {
			if ($(this).attr('data-stock') == data_stock) {
